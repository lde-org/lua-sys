...
do
  ...
  local g_noop   = state:load("function() end")
  local g_add    = state:load("function(a,b) return a+b end")
  local g_echo4  = state:load("function(a,b,c,d) return a,b,c,d end")
...
do
  ...
  local call_noop  = state:load("function() host_noop() end")
  local call_add   = state:load("function() host_add(1, 2) end")
  local call_echo4 = state:load("function() host_echo4(1,2,3,4) end")
...
do
  ...
  local round_trip = state:load("function(x) return host_inc(x) end")
